...
public class Product implements Serializable {
	...
	@Transient  // database table에 저장 안함
	private MultipartFile productImage;  // file type이 MultipartFile로 넘어온다 (file의 meta정보 포함해서~)
	
	private String imageFilename;  // filename만 저장
	
}  // hibernate = jpa + native 기능들
